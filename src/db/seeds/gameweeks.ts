...
export const gameweeks: NewGameweek[] = [
  { name: "Group Stage MD1", deadlineTime: new Date("2026-06-11T11:00:00Z"), isCurrent: true, isFinished: true },
  { name: "Group Stage MD2", deadlineTime: new Date("2026-06-18T11:00:00Z"), isCurrent: true, isFinished: false },
