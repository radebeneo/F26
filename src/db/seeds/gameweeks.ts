...
export const gameweeks: NewGameweek[] = [
  ...
  { name: "Round of 16", deadlineTime: new Date("2026-07-02T11:00:00Z"), isCurrent: false, isFinished: true },
  { name: "Quarter-finals", deadlineTime: new Date("2026-07-05T11:00:00Z"), isCurrent: false, isFinished: true },
  { name: "Semi-finals", deadlineTime: new Date("2026-07-14T11:00:00Z"), isCurrent: true, isFinished: false },
