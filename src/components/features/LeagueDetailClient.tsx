...
export function LeagueDetailClient({
  ...
  return (
    <div className="w-full flex flex-col h-full bg-[#1da1f2] p-4 md:p-8 text-black min-h-screen">
      <div className="max-w-5xl mx-auto w-full flex flex-col gap-6">
        ...
        {/* Main Card */}
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col border border-black/5">
          {/* Tabs */}
